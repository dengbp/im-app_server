...
public class UserInfoDetailController {
    ...
    @ResponseBody
    @Log("查询用户详细信息")
    public RestResult more(@RequestBody @Valid UserBaseInfoRequestDto requestDto) {
    ...
    @ResponseBody
    @Log("详细信息编辑")
    public RestResult detailEdit(@RequestBody @Valid UserDetailSetRequestDto requestDto){
