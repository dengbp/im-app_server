package com.yr.net.app.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://121.37.181.23:3306/appdata?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    ...
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.yr.net.app";
    // xml 文件模板
